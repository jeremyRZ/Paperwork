              ...
              child: SizedBox(
                ...
                child: isDark ? null : const DecoratedBox(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [Colours.gradient_blue, Color(0xFF19746c)]),
                  ),
                ),
              ),
            ),
      ...
      SliverOverlapAbsorber(
        ...
        sliver: SliverAppBar(
          ...
          flexibleSpace: MyFlexibleSpaceBar(
            background: isDark ? Container(height: 113.0, color: Colours.dark_bg_color,) : LoadAssetImage('order/order_bg_up',
              width: context.width,
              height: 113.0,
              fit: BoxFit.fill,
            ),
            ...
            title: Text('WCH Student Residence', style: TextStyle(color: ThemeUtils.getIconColor(context)),),
          ),
        ),
      ),
          ...
          DecoratedBox(
            decoration: BoxDecoration(
              ...
              image: isDark ? null : DecorationImage(
                image: ImageUtils.getAssetImage('order/order_bg_down'),
                fit: BoxFit.fill,
              ),
            ),
            child: Padding(
