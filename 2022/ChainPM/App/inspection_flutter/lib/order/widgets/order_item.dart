...
const List<String> orderLeftButtonText = ['Flag', '拒单', '订单跟踪', '订单跟踪', '订单跟踪'];
const List<String> orderRightButtonText = ['Detail', '开始配送', '完成', '', ''];
  ...
  Widget _buildContent(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Gaps.vGap8,
        Text(
          'Water Test for chassis enclosure ',
          style: Theme.of(context).textTheme.subtitle2,
        ),
        Gaps.vGap8,
        Gaps.line,
        ...
        RichText(
          text: TextSpan(
            style: textTextStyle,
            children: <TextSpan>[
              const TextSpan(text: 'Structure'),
              TextSpan(text: '  x9', style: Theme.of(context).textTheme.subtitle2),
            ],
          ),
        ),
        Gaps.vGap8,
        RichText(
          text: TextSpan(
            style: textTextStyle,
            children: <TextSpan>[
              const TextSpan(text: 'Door/Window'),
        ...
        RichText(
          text: TextSpan(
            style: textTextStyle,
            children: <TextSpan>[
              const TextSpan(text: 'Concreting'),
              TextSpan(text: '  x5', style: Theme.of(context).textTheme.subtitle2),
            ],
          ),
        ),
        Gaps.vGap8,
        ...
        RichText(
          text: TextSpan(
            style: textTextStyle,
            children: <TextSpan>[
              const TextSpan(text: 'Wet trades'),
              TextSpan(text: '  x9', style: Theme.of(context).textTheme.subtitle2),
            ],
          ),
        ),
        ...
        RichText(
          text: TextSpan(
            style: textTextStyle,
            children: <TextSpan>[
              const TextSpan(text: 'Painting'),
              TextSpan(text: '  x4', style: Theme.of(context).textTheme.subtitle2),
            ],
          ),
        ),
        Gaps.vGap8,
        RichText(
          text: TextSpan(
            style: textTextStyle,
            children: <TextSpan>[
              const TextSpan(text: 'MEP'),
              TextSpan(text: '  x3', style: Theme.of(context).textTheme.subtitle2),
            ],
          ),
        ),
        Gaps.vGap8,
        ...
        RichText(
          text: TextSpan(
            style: textTextStyle,
            children: <TextSpan>[
              const TextSpan(text: 'Cleaning/protection'),
              TextSpan(text: '  x2', style: Theme.of(context).textTheme.subtitle2),
            ],
          ),
        ),
        ...
        RichText(
          text: TextSpan(
            style: textTextStyle,
            children: <TextSpan>[
              const TextSpan(text: 'T&C Final Check'),
              TextSpan(text: '  x4', style: Theme.of(context).textTheme.subtitle2),
            ],
          ),
        ),
